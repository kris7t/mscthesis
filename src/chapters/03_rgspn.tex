...
\begin{dfn}\label{dfn:rgspn:rgspn}
  An \emph{\textabbr{RGSPN} signatrue} is a 11-tuple
  \begin{equation}
...
\begin{dfn}\label{dfn:rgspn:impl}
  An \emph{\textabbr{RGSPN}} is a 11-tuple \(N = \ltup \Sigma, m_0, \lambda, w, \pi, \rel{value}, {\outarc}, {\inarc}, {\inharc}, {\assign}, {\member} \rtup\), where
  \begin{compactitem}
