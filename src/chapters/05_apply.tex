...
\citet{Vanherpen14patterns} also classified the representations of 

% The model transformation proposed in our solution enables the use of a different representations for the exploration of candidate designs and their formal analysis. Traceability relations ensure that the results of the analysis can be interpreted as metrics of interest on the design candidate.
...
Lastly, the use of same transformation engine for batch transformation and incremental synchronization may impede generalization for other transformation approaches. The data structures required for incremental synchronization were constructed even if no incrementality was exploited afterwards, thereby penalizing the batch synchronization.