...
The aim of the analysis model is provide hazard rate analysis for port instances of components. Because port instances of component instances are not represented directly as objects in the architectural model, derived features cannot be used for the metrics. We instead directly bind a \lit{@FaultConfiguration} analysis annotation to a symbol in the \lit{PortModule}, which is instantiated for each port instance of each component instance.
